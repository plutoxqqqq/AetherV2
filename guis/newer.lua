...
function mainapi:CreateSearch()
	...
	-- Temporary text launcher until the final Kits artwork is available.
	...
	kitsbutton.AutoButtonColor = false
	...
	kitsbutton.MouseEnter:Connect(function()
		kitsbutton.TextColor3 = uipallet.Text
	end)
	kitsbutton.MouseLeave:Connect(function()
		kitsbutton.TextColor3 = color.Dark(uipallet.Text, 0.2)
	end)
	...
	search.Size = UDim2.new(1, -113, 0, 37)
