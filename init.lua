...
if not shared.VapeDeveloper then
	...
	if commit == 'main' or (isfile('aetherv2/profiles/commit.txt') and readfile('aetherv2/profiles/commit.txt') or '') ~= commit then
		wipeFolder('aetherv2')
...
return loadstring(downloadFile('aetherv2/main.lua'), 'main')()
