...
pcall(function()
	local body = game:HttpGet('https://raw.githubusercontent.com/plutoxqqqq/AetherV2/main/cache.lua?t='..tostring(os.clock()), true)
...
if not exists('aetherv2/main.lua') then
	local ok, body = pcall(function()
		local fetch = shared.AetherV2FetchSourceUrl
		return game:HttpGet((type(fetch)=='function' and fetch('main.lua')) or 'https://raw.githubusercontent.com/plutoxqqqq/AetherV2/main/main.lua', true)
	end)
